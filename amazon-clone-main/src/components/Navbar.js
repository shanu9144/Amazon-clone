      ...
      <div className="flex flex-col">
        <div className="flex items-center p-1 pl-4 pr-2 py-2">
          ...
          <div className={`hidden md:flex items-center space-x-4 mx-6 whitespace-nowrap ${isSearchVisible ? 'md:hidden' : ''}`}>
            ...
            <div className="link hover:outline hover:outline-1 hover:outline-white p-2 cursor-pointer">
              <p className="text-xs">Hello, Shantanu</p>
        ...
        <div className={`flex items-center bg-[#232f3e] text-sm w-full overflow-x-auto ${isSearchVisible ? 'hidden md:flex' : 'flex'}`}>
          <div className="flex items-center w-full px-4 py-2 space-x-4 text-base">
            <div className="flex items-center cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1" onClick={toggleSidebar}>
            ...
            <p className="cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1">Best Sellers</p>
            <p className="cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1">Mobiles</p>
            <p className="cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1">Electronics</p>
            <p className="hidden md:block cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1">Customer Service</p>
            <p className="hidden lg:block cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1">Prime</p>
            <p className="hidden lg:block cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1">Fashion</p>
            <p className="hidden xl:block cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1">New Releases</p>
            <p className="hidden xl:block cursor-pointer hover:outline hover:outline-1 hover:outline-white px-2 py-1">Home & Kitchen</p>
          </div>
        </div>
      </div>
    </nav>
